...
export const createTechnicalAnalysisPrompt = (symbol, currentDate) => {
    ...
    Use popular technical analysis strategies e.g. Moving Averages Crossover, Bollinger Bands narrowing, Support, Resistance and more. Reason what you see in the data and suggest a LONG position if you see a positive trend and a SHORT position if you see a negative trend. Else HOLD. 
    Also specify what the stop_loss percentage should be (value between 0 and 1) and what the exact take_profit price is with 4 decimal places. Explain why you chose these values based on the technical and price data.`;
};
