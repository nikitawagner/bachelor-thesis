...
export const createTechnicalAnalysisPrompt = (symbol, currentDate) => {
	return `The current date (todays date) is ${currentDate}. You are supposed to tell if the stock ${symbol} is a LONG or SHORT for the current date based on the technical data that you can use by function calling. You can access data for the last 30 days.
