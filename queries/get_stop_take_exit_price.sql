CREATE OR REPLACE FUNCTION public.get_stop_take_exit_price(p_ticker text, p_open_date timestamp with time zone, p_long_or_short action_type, p_stop_loss numeric, p_take_profit numeric, p_open_price numeric, p_price_type price_type, p_time_frame price_time_frame)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
DECLARE
