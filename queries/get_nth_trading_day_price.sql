CREATE OR REPLACE FUNCTION public.get_nth_trading_day_price(p_ticker text, 
p_open_date timestamp with time zone, p_n integer, p_price_type price_type, 
p_time_frame price_time_frame)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
DECLARE
